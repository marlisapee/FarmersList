...
describe('Cart Tests', () => {
  ...
  test('Can remove products from array with removeItemByName and total is updated', () => {
    const strawberries = new Product(
      'Strawberries',
      5,
      'The freshest fresas on the market'
...
describe('Customer Tests', () => {
  ...
  test('addToOrderHistory Cart to orderHistory array', () => {
    ...
    expect(francis.getRewardPoints()).toEqual(3);
  });

  test('getRewardPoints returns correct amount of points', () => {
    const francis = new Customer('Francis', 'francis@gmail.com', '222 Main St');
    const strawberries = new Product(
      'Strawberries',
      5,
    ...
    francis.addToOrderHistory(mySecondOrder);
    expect(francis.getRewardPoints()).toEqual(5);
  });
});
